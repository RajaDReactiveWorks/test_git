...
public class CloneHelper
{
    ...
    public Table clone(Table source, boolean cloneIndexes, boolean cloneForeignKeys, Database targetModel, boolean caseSensitive)
    {
        ...
        result.setPartitionSchema(source.getPartitionSchema());
        result.setTableSpaces(source.getTableSpaces());
        ...
        if(source.isPartitionSupported())
        {
        	result.setPartitionSupported(source.isPartitionSupported());
        	result.setPartitionType(source.getPartitionType());
        }
        return result;
    }
