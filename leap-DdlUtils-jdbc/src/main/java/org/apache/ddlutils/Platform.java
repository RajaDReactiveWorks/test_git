...
public interface Platform
{
	 ...
	 * using the default database connection, without table drop & data erase
	 * 
	 * @param dropTable
	 *            Is ordered to drop the existing model and recreate
	 * @param cleartable
	 *            Is ordered to clear the data in the table
	 * @param currentModel
	 ...
	 *            occurred
	 */
	public void alterModelExtended(boolean dropTable, Database currentModel, Database desiredModel, boolean continueOnError);
