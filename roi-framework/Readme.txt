...
-----------------------------------
 	A property file named “configurationDB.properties” available in “roi-framework” project inside “resources” folder. Change it to the database properties of your system
...
---------------------------
	In this, all the test cases written for framework (“roi-framework”) is executed at once.
To do this, follow the below steps:
•	Go the “roi-framework” project location from command line. You can see the pom.xml file written for the project in that folder.
...
To do this, follow the below steps:
•	From eclipse/fuse IDE, open “src/test/java” then open a package name “com.getusroi.test.suite” of project “roi-framework”.
