 ...
 * The Bean loading can vary based on the enviorment.
 * 1.) Normal java will be class.forname.
 * 2.) normal OSGI through the OSGI Registry
 * 3.) OSGI Blueprint through BlueprintRegistry
 * 4.) Spring through the Spring Registry
 * @author amit
 *
 */
