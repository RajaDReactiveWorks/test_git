 ...
 */
public class ROIBaseConfigEvent implements Serializable{
	...
	public ROIBaseConfigEvent(String tenantId, ConfigurationUnit newConfigUnit,
			String eventType) {
		super();
		this.tenantId = tenantId;
		this.newConfigUnit = newConfigUnit;
	...
	public String toString() {
		return "ROIBaseConfigEvent [tenantId=" + tenantId + ", newConfigUnit="
