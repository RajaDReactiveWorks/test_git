    ...
    implements Serializable
{
    ...
    @XmlAttribute(name = "overrideExistingNode", required = false)
    protected Boolean overrideExistingNode;
    
    
    
    public Boolean getOverrideExistingNode() {
		return overrideExistingNode;
	}

	public void setOverrideExistingNode(Boolean overrideExistingNode) {
		this.overrideExistingNode = overrideExistingNode;
	}
