...
public class FeatureDeploymentServiceTest {
	...
	public void testActiveAndPrimaryFeatureFromFeatureDeployment() throws FeatureDeploymentServiceException{
		...
		LeapHeader lp = new LeapHeader();
		FeatureDeployment featuredeployment =featureDeploymentService.getActiveAndPrimaryFeatureDeployedFromCache(GenericTestConstant.TEST_TENANTID, GenericTestConstant.TEST_SITEID, GenericTestConstant.TEST_FEATURE,lp);
	...
	public void updateFeatureDeploymentFromNotPrimaryToPrimaryTest() throws FeatureDeploymentServiceException{
		...
		FeatureDeployment featuredeploymentAfterUpdate =featureDeploymentService.getActiveAndPrimaryFeatureDeployedFromCache(GenericTestConstant.TEST_TENANTID, GenericTestConstant.TEST_SITEID, GenericTestConstant.TEST_FEATURE, lp);
