...
@XmlType(name = "", propOrder = { "featureGroup" })
@XmlRootElement(name = "Feature-Metainfo", namespace = "")
public class FeatureMetainfo implements Serializable {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link FeatureGroup
	 * }
	 * 
	 * 
	 */
